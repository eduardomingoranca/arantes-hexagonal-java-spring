...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, CustomerMessage> consumerFactory() {
        ...
        JsonDeserializer<CustomerMessage> customerMessageJsonDeserializer = new
                JsonDeserializer<>(CustomerMessage.class);
        return new DefaultKafkaConsumerFactory<>(props, stringDeserializer, customerMessageJsonDeserializer);
    }
